...
wget -O /usr/bin/menu https://raw.githubusercontent.com/Dimas1441/error/main/menu.sh && chmod +x /usr/bin/menu
...
wget -O /usr/bin/bannerku https://raw.githubusercontent.com/Dimas1441/error/main/bannerku && chmod +x /usr/bin/bannerku
...
wget -O /usr/bin/xp-trgo https://raw.githubusercontent.com/Dimas1441/error/main/update/xp-trgo.sh && chmod +x /usr/bin/xp-trgo
