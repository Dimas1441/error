...
# install v2ray
wget https://raw.githubusercontent.com/Dimas1441/error/main/go.sh && dos2unix go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
...
$uuid
EOF
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 1419 -j ACCEPT
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 8443 -j ACCEPT
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 80 -j ACCEPT
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 8442 -j ACCEPT
iptables -I INPUT -m state --state NEW -m tcp -p tcp --dport 8880 -j ACCEPT
iptables -I INPUT -m state --state NEW -m udp -p udp --dport 1419 -j ACCEPT
...
wget -O add-tr "https://raw.githubusercontent.com/Dimas1441/error/main/add-tr.sh"
wget -O del-ws "https://raw.githubusercontent.com/Dimas1441/error/main/del-ws.sh"
wget -O del-vless "https://raw.githubusercontent.com/Dimas1441/error/main/del-vless.sh"
wget -O del-tr "https://raw.githubusercontent.com/Dimas1441/error/main/del-tr.sh"
wget -O cek-ws "https://raw.githubusercontent.com/Dimas1441/error/main/cek-ws.sh"
wget -O cek-vless "https://raw.githubusercontent.com/Dimas1441/error/main/cek-vless.sh"
wget -O cek-tr "https://raw.githubusercontent.com/Dimas1441/error/main/cek-tr.sh"
...
chmod +x renew-tr
cd /usr/bin
wget -O xp-ws "https://raw.githubusercontent.com/Dimas1441/error/main/xp-ws.sh"
wget -O xp-tr "https://raw.githubusercontent.com/Dimas1441/error/main/xp-tr.sh"
wget -O xp-vless "https://raw.githubusercontent.com/Dimas1441/error/main/xp-vless.sh"
