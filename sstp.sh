...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/Dimas1441/error/main/accel.conf"
...
wget -O /usr/bin/panel-sstp https://raw.githubusercontent.com/Dimas1441/error/main/panel-sstp.sh && dos2unix panel-sstp /usr/bin/panel-sstp && chmod +x /usr/bin/panel-sstp
wget -O /usr/bin/add-sstp https://raw.githubusercontent.com/Dimas1441/ipvps/main/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -O /usr/bin/del-sstp https://raw.githubusercontent.com/Dimas1441/ipvps/main/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -O /usr/bin/cek-sstp https://raw.githubusercontent.com/Dimas1441/ipvps/main/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -O /usr/bin/renew-sstp https://raw.githubusercontent.com/Dimas1441/ipvps/main/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
echo " Done Install Module SSTP "
rm -f /root/sstp.sh
